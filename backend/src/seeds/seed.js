...
export const seedDatabase = async () => {
  ...
  const colleges = [
    ...
    },
    {
      ...
      college_code: 'VNR-VJIET',
      address: 'Vignana Jyothi Nagar, Pragathi Nagar, Nizampet, Hyderabad, Telangana 500090',
      state: 'Telangana',
      email: 'admin@vnrvjiet.ac.in',
      phone: '+91 40 2304 2758',
      website: 'http://www.vnrvjiet.ac.in',
      university: 'Jawaharlal Nehru Technological University Hyderabad (Autonomous)',
      verification_status: 'VERIFIED',
      verified_at: '2026-03-12T10:00:00.000Z',
      verified_by: 'usr_superadmin',
      logo_url: 'https://api.dicebear.com/7.x/identicon/svg?seed=VNRVJIET',
      created_at: '2026-02-22T08:00:00.000Z'
    },
    {
      id: 'col_ou',
      name: 'University College of Engineering, Osmania University',
      college_code: 'UCEOU-HYD',
      address: 'Osmania University Campus, Amberpet, Hyderabad, Telangana 500007',
      state: 'Telangana',
      ...
      verification_status: 'VERIFIED',
      verified_at: '2026-03-14T09:30:00.000Z',
      verified_by: 'usr_superadmin',
      logo_url: 'https://api.dicebear.com/7.x/identicon/svg?seed=UCEOU',
      created_at: '2026-02-25T08:00:00.000Z'
    },
    {
      id: 'col_vasavi',
      name: 'Vasavi College of Engineering',
      college_code: 'VCE-HYD',
      address: '9-5-81, Ibrahimbagh, Hyderabad, Telangana 500031',
      state: 'Telangana',
      email: 'principal@staff.vce.ac.in',
      phone: '+91 40 2314 6003',
      website: 'https://www.vce.ac.in',
      university: 'Osmania University (Autonomous)',
      verification_status: 'VERIFIED',
      verified_at: '2026-03-15T11:00:00.000Z',
      verified_by: 'usr_superadmin',
      logo_url: 'https://api.dicebear.com/7.x/identicon/svg?seed=VCE',
